...
object BackendType {
  ...
  def toErasedBackendType(tpe: SimpleType): BackendType = tpe match {
    ...
    case SimpleType.Void | SimpleType.AnyType | SimpleType.Unit | SimpleType.BigDecimal | SimpleType.BigInt |
         SimpleType.String | SimpleType.Regex | SimpleType.StringBuilderHandle | SimpleType.RegexMatcher | SimpleType.ChannelHandle | SimpleType.ReentrantLockHandle | SimpleType.Array(_) | SimpleType.Lazy(_) |
